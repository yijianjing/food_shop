...
import com.imooc.entity.vo.MerchantOrdersVO;
...
//        newOrder.setRealPayAmount();
    ...
    public void updateOrderStatus(String orderId, Integer orderStatus) {
        ...
        orderStatusMapper.update(paidStatus,new LambdaQueryWrapper<OrderStatus>()
    ...
    public OrderStatus queryOrderStatusInfo(String orderId) {
        return orderStatusMapper.selectOne(new LambdaQueryWrapper<OrderStatus>()
                .eq(OrderStatus::getOrderId,orderId));
    }
    ...
    public void closeOrder() {
        ...
        List<OrderStatus> list = orderStatusMapper.selectList(new LambdaQueryWrapper<OrderStatus>()
                .eq(OrderStatus::getOrderStatus,queryOrder.getOrderStatus()));
    ...
    void doCloseOrder(String orderId) {
        ...
        orderStatusMapper.update(close,new LambdaQueryWrapper<OrderStatus>()
                .eq(OrderStatus::getOrderId,orderId));
    }
}